<template>
  <h2 class="mb-5">Dispenser 0x45Dc....Ef62Cf</h2>
  ...
  <v-row>
    ...
    <v-col cols="12" md="7">
      ...
      <v-sheet class="mb-3 pa-3" color="plaster">
...
},
{
    ...
    url: "https://someurl.com/2.png",
      ...
      <v-btn color="primary" flat block>Load Dispenser</v-btn>
    </v-col>
  </v-row>
</template>
