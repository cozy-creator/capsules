module nft_dispenser::nft_dispenser {
    ...
    use dispenser::dispenser::{Self, RANDOMNESS_WITNESS, AdminCap, Dispenser};
    ...
    public entry fun dispense(dispenser: &mut Dispenser, randomness: &mut Randomness<RANDOMNESS_WITNESS>, coins: vector<Coin<SUI>>, sig: vector<u8>, ctx: &mut TxContext) {
        let data = dispenser::random_dispense(dispenser, randomness, coins, sig, ctx);
