module capsule_baby::capsule_baby {
    ...
    use ownership::ownership::{Self, can_act_as_owner, can_act_as_declaring_package};
    ...
    public fun create_baby_(
        ...
        let auth = tx_authority::begin_with_package_witness<Witness, ADMIN>(Witness {});
    ...
    public fun edit_baby_name(
        ...
        assert!(can_act_as_owner<EDITOR>(&baby.id, auth) || 
            can_act_as_declaring_package<EDITOR>(&baby.id, auth), ENO_AUTHORITY);
