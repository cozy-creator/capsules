...
bcs.registerStructType(
  "0x3a73bc0427056f5ed45c5689af50415c55b5a2ff31e47939859a2fbece79a173::probability_distribution::ProbabilityDistribution",
  {
...
export class ProbabilityDistribution {
  ...
  static fromFields(fields: Record<string, any>): ProbabilityDistribution {
    return new ProbabilityDistribution({
      ...
      weightedHigh:
        Option.fromFields<boolean>(`bool`, fields.weighted_high).vec[0] || null,
    });
  }
