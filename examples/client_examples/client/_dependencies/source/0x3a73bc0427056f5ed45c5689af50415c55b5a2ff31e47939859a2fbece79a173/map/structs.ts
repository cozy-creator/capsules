...
bcs.registerStructType(
  "0x3a73bc0427056f5ed45c5689af50415c55b5a2ff31e47939859a2fbece79a173::map::Iter<Key>",
  {
    for: `0x2::object::ID`,
    keys: `vector<Key>`,
  }
...
export function isIter(type: Type): boolean {
  return type.startsWith(
    "0x3a73bc0427056f5ed45c5689af50415c55b5a2ff31e47939859a2fbece79a173::map::Iter<"
  );
}
...
bcs.registerStructType(
  "0x3a73bc0427056f5ed45c5689af50415c55b5a2ff31e47939859a2fbece79a173::map::Map<Key, Value>",
  {
    id: `0x2::object::UID`,
    index: `vector<Key>`,
  }
...
export function isMap(type: Type): boolean {
  return type.startsWith(
    "0x3a73bc0427056f5ed45c5689af50415c55b5a2ff31e47939859a2fbece79a173::map::Map<"
  );
}
