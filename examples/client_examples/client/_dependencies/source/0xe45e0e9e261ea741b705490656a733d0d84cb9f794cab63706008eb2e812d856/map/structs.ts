...
bcs.registerStructType(
  "0xe45e0e9e261ea741b705490656a733d0d84cb9f794cab63706008eb2e812d856::map::Iter<Key>",
  {
    for: `0x2::object::ID`,
    keys: `vector<Key>`,
  }
...
export function isIter(type: Type): boolean {
  return type.startsWith(
    "0xe45e0e9e261ea741b705490656a733d0d84cb9f794cab63706008eb2e812d856::map::Iter<"
  );
}
...
bcs.registerStructType(
  "0xe45e0e9e261ea741b705490656a733d0d84cb9f794cab63706008eb2e812d856::map::Map<Key, Value>",
  {
    id: `0x2::object::UID`,
    index: `vector<Key>`,
  }
...
export function isMap(type: Type): boolean {
  return type.startsWith(
    "0xe45e0e9e261ea741b705490656a733d0d84cb9f794cab63706008eb2e812d856::map::Map<"
  );
}
