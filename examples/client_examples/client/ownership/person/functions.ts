...
export function agentActionsMut(
  txb: TransactionBlock,
  args: AgentActionsMutArgs
) {
  return txb.moveCall({
...
export function agentActionsValue(
  txb: TransactionBlock,
  args: AgentActionsValueArgs
) {
  return txb.moveCall({
...
export function claimDelegation_(
  txb: TransactionBlock,
  args: ClaimDelegation_Args
) {
  return txb.moveCall({
