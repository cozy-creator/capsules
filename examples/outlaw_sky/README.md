...
> ID: 0x479d7d5cec221e820cddda1d67567a8d349ad613 , Owner: Account Address ( 0xbb81965d327c51d42d1081e5d81909652f05a675 )
...
Schemas are immutable root-level owned objects used to enforce `(field-name, type)` pairings, making (de)serialization of on-chain metadata possible. Because schema-objects are immutable, they can never change or be deleted; if you want to change something about a schema, you'll have to create a new schema object. Normally you'd select some standard schema, such as `0x18c9ea0209736c2f30aa0d3ff58930f653bd2040`, but if you want to write and deploy your own custom schema, use the following command:

`sui client call --package 0xd6314e8ae2a9b6564a053c6757a56a987e4263b4 --module schema --function create --args "[ [\"name\", \"String\"], [ \"description\", \"Option<String>\" ], [ \"image\", \"String\" ], [ \"power_level\", \"u64\" ], [ \"attributes\", \"VecMap<String,String>\"] ]" --gas-budget 3000`
...
`sui client call --package 0xd6314e8ae2a9b6564a053c6757a56a987e4263b4 --module type --function define --type-args 0x6691bfa9161530a5ba94f7b744608e03d55aedf6::outlaw_sky::Outlaw --args 0x479d7d5cec221e820cddda1d67567a8d349ad613 "[ [79, 117, 116, 108, 97, 119], [84, 104, 101, 115, 101, 32, 97, 114, 101, 32, 100, 101, 109, 111, 32, 79, 117, 116, 108, 97, 119, 115, 32, 99, 114, 101, 97, 116, 101, 100, 32, 98, 121, 32, 67, 97, 112, 115, 117, 108, 101, 67, 114, 101, 97, 116, 111, 114, 32, 102, 111, 114, 32, 111, 117, 114, 32, 116, 117, 116, 111, 114, 105, 97, 108], [104, 116, 116, 112, 115, 58, 47, 47, 112, 98, 115, 46, 116, 119, 105, 109, 103, 46, 99, 111, 109, 47, 112, 114, 111, 102, 105, 108, 101, 95, 105, 109, 97, 103, 101, 115, 47, 49, 53, 54, 57, 55, 50, 55, 51, 50, 52, 48, 56, 49, 51, 50, 56, 49, 50, 56, 47, 55, 115, 85, 110, 74, 118, 82, 103, 95, 52, 48, 48, 120, 52, 48, 48, 46, 106, 112, 103], [199, 0, 0, 0, 0, 0, 0, 0], [] ]" 0x18c9ea0209736c2f30aa0d3ff58930f653bd2040 --gas-budget 8000`
...
`sui client call --package 0xd6314e8ae2a9b6564a053c6757a56a987e4263b4 --module type --function update --type-args 0x6691bfa9161530a5ba94f7b744608e03d55aedf6::outlaw_sky::Outlaw --args 0xf6394c2f5c3c53268247ccfc26620664f7ac7c2b "[ \"description\", \"image\", \"power_level\" ]" "[ [84, 104, 101, 115, 101, 32, 97, 114, 101, 32, 100, 101, 109, 111, 32, 79, 117, 116, 108, 97, 119, 115, 32, 99, 114, 101, 97, 116, 101, 100, 32, 98, 121, 32, 67, 97, 112, 115, 117, 108, 101, 67, 114, 101, 97, 116, 111, 114, 32, 102, 111, 114, 32, 111, 117, 114, 32, 116, 117, 116, 111, 114, 105, 97, 108], [104, 116, 116, 112, 115, 58, 47, 47, 112, 98, 115, 46, 116, 119, 105, 109, 103, 46, 99, 111, 109, 47, 112, 114, 111, 102, 105, 108, 101, 95, 105, 109, 97, 103, 101, 115, 47, 49, 53, 54, 57, 55, 50, 55, 51, 50, 52, 48, 56, 49, 51, 50, 56, 49, 50, 56, 47, 55, 115, 85, 110, 74, 118, 82, 103, 95, 52, 48, 48, 120, 52, 48, 48, 46, 106, 112, 103], [199, 0, 0, 0, 0, 0, 0, 0] ]" 0x18c9ea0209736c2f30aa0d3ff58930f653bd2040 true --gas-budget 2000`
...
`sui client call --package 0x6691bfa9161530a5ba94f7b744608e03d55aedf6 --module outlaw_sky --function create --args "[ [75, 121, 114, 105, 101], [], [104, 116, 116, 112, 115, 58, 47, 47, 112, 98, 115, 46, 116, 119, 105, 109, 103, 46, 99, 111, 109, 47, 112, 114, 111, 102, 105, 108, 101, 95, 105, 109, 97, 103, 101, 115, 47, 49, 53, 54, 57, 55, 50, 55, 51, 50, 52, 48, 56, 49, 51, 50, 56, 49, 50, 56, 47, 55, 115, 85, 110, 74, 118, 82, 103, 95, 52, 48, 48, 120, 52, 48, 48, 46, 106, 112, 103], [0, 0, 1, 0, 0, 0, 0, 0], [ 10, 66, 97, 99, 107, 103, 114, 111, 117, 110, 100, 5, 87, 104, 105, 116, 101, 4, 70, 97, 99, 101, 9, 87, 104, 111, 108, 101, 115, 111, 109, 101 ] ]" 0x18c9ea0209736c2f30aa0d3ff58930f653bd2040 --gas-budget 9000`
...
> Created Objects:
>
> - ID: 0x1ca3c86fed5ad637143f15a81d2cc31a9ddb4144 , Owner: Object ID: ( 0x67c6f1361f8b424511e567cef33a3a760513484d )
> - ID: 0x3137d76eaeefe7e396d1315eb47356aa7c271ce1 , Owner: Object ID: ( 0x67c6f1361f8b424511e567cef33a3a760513484d )
> - ID: 0x67c6f1361f8b424511e567cef33a3a760513484d , Owner: Shared
> - ID: 0x51673c014cf020f331982096c68c7e29a4e958d4 , Owner: Object ID: ( 0x67c6f1361f8b424511e567cef33a3a760513484d )
> - ID: 0x68e194c2373109a10bb36f569080647f64e71b4f , Owner: Object ID: ( 0x67c6f1361f8b424511e567cef33a3a760513484d )
> - ID: 0x85af2fe01dfaa623eeeb34a5388de932efe5675c , Owner: Object ID: ( 0x67c6f1361f8b424511e567cef33a3a760513484d )
> - ID: 0x952260e682f3ec20944d75518cd6b46fffa5c611 , Owner: Object ID: ( 0x67c6f1361f8b424511e567cef33a3a760513484d )
> - ID: 0xa153e1aba646baa0e4c210d5b2e7c7de63aa42c3 , Owner: Object ID: ( 0x67c6f1361f8b424511e567cef33a3a760513484d )
> - ID: 0xf41403d7706f796b2b9fba8d6ac825bc48196b28 , Owner: Object ID: ( 0x67c6f1361f8b424511e567cef33a3a760513484d )
>
>   Mutated Objects:
>
> - ID: 0x34b29facfdc4f34e97219d2a02e648b0f30b43de , Owner: Account Address ( 0xbb81965d327c51d42d1081e5d81909652f05a675 )

What are all these objects? For Sui, every dynamic field we add is its own 'object'; as you can see, all of these objects are owned by one object: `0x67c6f1361f8b424511e567cef33a3a760513484d`; that's our Outlaw! And all of the other objects are its dynamic fields.
...
[https://explorer.sui.io/object/0x67c6f1361f8b424511e567cef33a3a760513484d?network=devnet]()
        ...
        [
            {
                "moveCallRequestParams": {
                    "packageObjectId": "0x6691bfa9161530a5ba94f7b744608e03d55aedf6",
                    "module": "outlaw_sky",
                    "function": "view_all",
                    "typeArguments": [],
                    "arguments": ["0x67c6f1361f8b424511e567cef33a3a760513484d", "0x18c9ea0209736c2f30aa0d3ff58930f653bd2040"]
                }
            }
        ],
...
`sui client call --package 0x6691bfa9161530a5ba94f7b744608e03d55aedf6 --module outlaw_sky --function delete_all --args 0x18c9ea0209736c2f30aa0d3ff58930f653bd2040 --gas-budget 9000`
...
Metadata package = 0xd6314e8ae2a9b6564a053c6757a56a987e4263b4
Outlaw Sky package = 0x6691bfa9161530a5ba94f7b744608e03d55aedf6
Publish Receipt Object = 0x479d7d5cec221e820cddda1d67567a8d349ad613
Outlaw Object = 0x67c6f1361f8b424511e567cef33a3a760513484d
Schema Object = 0x18c9ea0209736c2f30aa0d3ff58930f653bd2040
`Type<Outlaw> Object` = 0xf6394c2f5c3c53268247ccfc26620664f7ac7c2b
