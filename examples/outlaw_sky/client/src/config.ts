...
export const adminKeypair = Ed25519Keypair.deriveKeypair(
  <string>process.env.ADMIN_MNEMONICS
);
export const ownerKeypair = Ed25519Keypair.deriveKeypair(
  <string>process.env.OWNER_MNEMONICS
);
export const agentKeypair = Ed25519Keypair.deriveKeypair(
  <string>process.env.AGENT_MNEMONICS
);
