...
bcs.registerStructType(
    "0x68d0d4a8bd43e4ac81eaa9049ed13fbd4ab8cad89f80e0688ec9316084236b64::warship::Witness",
    {
        dummy_field: `bool`,
    }
)
...
bcs.registerStructType(
    "0x68d0d4a8bd43e4ac81eaa9049ed13fbd4ab8cad89f80e0688ec9316084236b64::warship::Warship",
    {
        id: `0x2::object::UID`,
    }
)
...
export class Warship {
    ...
    static async fetch(provider: JsonRpcProvider, id: ObjectId): Promise<Warship> {
        ...
        if (res.data?.content?.dataType !== "moveObject" || !isWarship(res.data.content.type)) {
