...
export interface CreateArgs {
  data:
    ...
    | TransactionArgument;
  fields:
    | Array<Array<string | TransactionArgument> | TransactionArgument>
    | TransactionArgument;
...
export function incrementPowerLevel(
  txb: TransactionBlock,
  args: IncrementPowerLevelArgs
) {
  return txb.moveCall({
...
export function incrementPowerLevel2(
  txb: TransactionBlock,
  args: IncrementPowerLevel2Args
) {
  return txb.moveCall({
