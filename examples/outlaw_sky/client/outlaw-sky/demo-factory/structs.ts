...
bcs.registerStructType(
    "0x68d0d4a8bd43e4ac81eaa9049ed13fbd4ab8cad89f80e0688ec9316084236b64::demo_factory::MetadataUpdated",
    {
        for: `0x2::object::ID`,
        metadata: `0x68d0d4a8bd43e4ac81eaa9049ed13fbd4ab8cad89f80e0688ec9316084236b64::demo_factory::OutlawMetadata`,
    }
)
...
export class MetadataUpdated {
    ...
    static fromBcs(data: Uint8Array | string, encoding?: Encoding): MetadataUpdated {
        return MetadataUpdated.fromFields(bcs.de([MetadataUpdated.$typeName], data, encoding))
    }
}
...
bcs.registerStructType(
    "0x68d0d4a8bd43e4ac81eaa9049ed13fbd4ab8cad89f80e0688ec9316084236b64::demo_factory::Outlaw",
    {
        id: `0x2::object::UID`,
...
bcs.registerStructType(
    "0x68d0d4a8bd43e4ac81eaa9049ed13fbd4ab8cad89f80e0688ec9316084236b64::demo_factory::OutlawMetadata",
    {
...
export class OutlawMetadata {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): OutlawMetadata {
        ...
        return new OutlawMetadata({
            attributes: VecMap.fromFieldsWithTypes<string, string>(item.fields.attributes),
            url: item.fields.url,
        })
    }

    static fromBcs(data: Uint8Array | string, encoding?: Encoding): OutlawMetadata {
        return OutlawMetadata.fromFields(bcs.de([OutlawMetadata.$typeName], data, encoding))
    }
}
