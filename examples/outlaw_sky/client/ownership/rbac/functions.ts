...
export function create(txb: TransactionBlock, principal: string | TransactionArgument) {
    return txb.moveCall({
...
export function deleteRoleAndAgents(txb: TransactionBlock, args: DeleteRoleAndAgentsArgs) {
    return txb.moveCall({
        ...
        arguments: [obj(txb, args.rbac), pure(txb, args.role, `0x1::string::String`)],
    })
}
...
export function getAgentActions(txb: TransactionBlock, args: GetAgentActionsArgs) {
    return txb.moveCall({
