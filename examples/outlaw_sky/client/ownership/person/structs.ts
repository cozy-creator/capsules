...
bcs.registerStructType(
    "0x98eff0617dfece5a417af4e2d2338afdfc5124e35a337c530161e8f3d7ac3e96::person::Key",
    {
        agent: `address`,
    }
)
...
export function isKey(type: Type): boolean {
    return (
        type === "0x98eff0617dfece5a417af4e2d2338afdfc5124e35a337c530161e8f3d7ac3e96::person::Key"
    )
}
...
bcs.registerStructType(
    "0x98eff0617dfece5a417af4e2d2338afdfc5124e35a337c530161e8f3d7ac3e96::person::Person",
    {
        id: `0x2::object::UID`,
        principal: `address`,
        guardian: `address`,
...
export class Person {
    ...
    static async fetch(provider: JsonRpcProvider, id: ObjectId): Promise<Person> {
        ...
        if (res.error) {
            throw new Error(`error fetching Person object at id ${id}: ${res.error.code}`)
        }
        if (res.data?.content?.dataType !== "moveObject" || !isPerson(res.data.content.type)) {
