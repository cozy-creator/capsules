...
export function claim(txb: TransactionBlock, typeArg: Type, genesis: GenericArg) {
    return txb.moveCall({
...
export function didPublish(txb: TransactionBlock, typeArg: Type, publisher: ObjectArg) {
    return txb.moveCall({
...
export function didPublish_(txb: TransactionBlock, args: DidPublish_Args) {
    return txb.moveCall({
        ...
        arguments: [obj(txb, args.publisher), pure(txb, args.id, `0x2::object::ID`)],
    })
}
