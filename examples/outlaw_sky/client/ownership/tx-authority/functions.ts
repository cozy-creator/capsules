...
export function addActionsInternal(txb: TransactionBlock, args: AddActionsInternalArgs) {
    return txb.moveCall({
...
export function addOrganizationInternal(txb: TransactionBlock, args: AddOrganizationInternalArgs) {
    return txb.moveCall({
...
export function addPackageWitness(
    ...
    return txb.moveCall({
        ...
        arguments: [generic(txb, `${typeArgs[0]}`, args.witness), obj(txb, args.auth)],
    })
}
...
export function addType(txb: TransactionBlock, typeArg: Type, args: AddTypeArgs) {
    return txb.moveCall({
...
export function beginWithType(txb: TransactionBlock, typeArg: Type, cap: GenericArg) {
    return txb.moveCall({
...
export function canActAsAddress(txb: TransactionBlock, typeArg: Type, args: CanActAsAddressArgs) {
    return txb.moveCall({
...
export function canActAsId(txb: TransactionBlock, typeArgs: [Type, Type], args: CanActAsIdArgs) {
    return txb.moveCall({
...
export function canActAsId_(txb: TransactionBlock, typeArg: Type, args: CanActAsId_Args) {
    return txb.moveCall({
...
export function canActAsPackage(txb: TransactionBlock, typeArgs: [Type, Type], auth: ObjectArg) {
    return txb.moveCall({
...
export function canActAsPackage_(txb: TransactionBlock, typeArg: Type, args: CanActAsPackage_Args) {
    return txb.moveCall({
        target: `${PUBLISHED_AT}::tx_authority::can_act_as_package_`,
        typeArguments: [typeArg],
        arguments: [pure(txb, args.packageId, `0x2::object::ID`), obj(txb, args.auth)],
    })
}
...
export function canActAsType(txb: TransactionBlock, typeArgs: [Type, Type], auth: ObjectArg) {
    return txb.moveCall({
...
export function isModuleAuthority(txb: TransactionBlock, typeArgs: [Type, Type]) {
    return txb.moveCall({
...
export function mergeActionSetInternal(txb: TransactionBlock, args: MergeActionSetInternalArgs) {
    return txb.moveCall({
...
export function newInternal(txb: TransactionBlock, principal: string | TransactionArgument) {
    return txb.moveCall({
...
export function tallyAgentsWithAction(
    ...
    return txb.moveCall({
        ...
        typeArguments: [typeArg],
        arguments: [pure(txb, args.principals, `vector<address>`), obj(txb, args.auth)],
    })
}
