...
export function canActAsAddressOnObject(
    ...
    return txb.moveCall({
        ...
        arguments: [pure(txb, args.principal, `address`), obj(txb, args.uid), obj(txb, args.auth)],
    })
}
...
export function asOwnedObject(txb: TransactionBlock, typeArg: Type, args: AsOwnedObjectArgs) {
    return txb.moveCall({
        target: `${PUBLISHED_AT}::ownership::as_owned_object`,
        typeArguments: [typeArg],
        arguments: [obj(txb, args.uid), obj(txb, args.typedId), obj(txb, args.auth)],
    })
}
...
export function asSharedObject_(txb: TransactionBlock, typeArg: Type, args: AsSharedObject_Args) {
    return txb.moveCall({
...
export function canActAsOwner(txb: TransactionBlock, typeArg: Type, args: CanActAsOwnerArgs) {
    return txb.moveCall({
...
export function canBorrowUidMut(txb: TransactionBlock, args: CanBorrowUidMutArgs) {
    return txb.moveCall({
...
export function ejectTransferAuth(txb: TransactionBlock, args: EjectTransferAuthArgs) {
    return txb.moveCall({
...
export function freezeTransfer(txb: TransactionBlock, args: FreezeTransferArgs) {
    return txb.moveCall({
...
export function makeOwnerImmutable(txb: TransactionBlock, args: MakeOwnerImmutableArgs) {
    return txb.moveCall({
...
export function setTransferAuth(txb: TransactionBlock, args: SetTransferAuthArgs) {
    return txb.moveCall({
        target: `${PUBLISHED_AT}::ownership::set_transfer_auth`,
        arguments: [obj(txb, args.uid), pure(txb, args.newAuth, `address`), obj(txb, args.auth)],
    })
}
...
export function unfreezeTransfer(txb: TransactionBlock, args: UnfreezeTransferArgs) {
    return txb.moveCall({
