...
export function transfer(txb: TransactionBlock, args: TransferArgs) {
    return txb.moveCall({
        ...
        arguments: [obj(txb, args.uid), pure(txb, args.newOwner, `address`), obj(txb, args.auth)],
    })
}
...
export function transferToObject(txb: TransactionBlock, typeArg: Type, args: TransferToObjectArgs) {
    return txb.moveCall({
        target: `${PUBLISHED_AT}::org_transfer::transfer_to_object`,
        typeArguments: [typeArg],
        arguments: [obj(txb, args.uid), generic(txb, `${typeArg}`, args.obj), obj(txb, args.auth)],
    })
}
...
export function transferToType(txb: TransactionBlock, typeArg: Type, args: TransferToTypeArgs) {
    return txb.moveCall({
