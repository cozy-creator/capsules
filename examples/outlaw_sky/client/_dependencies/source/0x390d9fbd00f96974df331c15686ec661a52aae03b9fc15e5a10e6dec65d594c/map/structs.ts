...
bcs.registerStructType(
    "0x390d9fbd00f96974df331c15686ec661a52aae03b9fc15e5a10e6dec65d594c::map::Iter<Key>",
    {
        for: `0x2::object::ID`,
        keys: `vector<Key>`,
    }
...
export function isIter(type: Type): boolean {
    return type.startsWith(
        "0x390d9fbd00f96974df331c15686ec661a52aae03b9fc15e5a10e6dec65d594c::map::Iter<"
    )
}
...
bcs.registerStructType(
    "0x390d9fbd00f96974df331c15686ec661a52aae03b9fc15e5a10e6dec65d594c::map::Map<Key, Value>",
    {
        id: `0x2::object::UID`,
        index: `vector<Key>`,
    }
...
export function isMap(type: Type): boolean {
    return type.startsWith(
        "0x390d9fbd00f96974df331c15686ec661a52aae03b9fc15e5a10e6dec65d594c::map::Map<"
    )
}
