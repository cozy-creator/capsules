...
bcs.registerStructType(
  "0x390d9fbd00f96974df331c15686ec661a52aae03b9fc15e5a10e6dec65d594c::vec_set2::VecSet<K>",
  {
    contents: `vector<K>`,
  }
);
...
export function isVecSet(type: Type): boolean {
  return type.startsWith(
    "0x390d9fbd00f96974df331c15686ec661a52aae03b9fc15e5a10e6dec65d594c::vec_set2::VecSet<"
  );
}
