...
bcs.registerStructType(
    "0x390d9fbd00f96974df331c15686ec661a52aae03b9fc15e5a10e6dec65d594c::immutable::Immutable<T>",
    {
        id: `0x2::object::UID`,
        allow_read: `bool`,
        contents: `T`,
...
export function isImmutable(type: Type): boolean {
    return type.startsWith(
        "0x390d9fbd00f96974df331c15686ec661a52aae03b9fc15e5a10e6dec65d594c::immutable::Immutable<"
    )
}
