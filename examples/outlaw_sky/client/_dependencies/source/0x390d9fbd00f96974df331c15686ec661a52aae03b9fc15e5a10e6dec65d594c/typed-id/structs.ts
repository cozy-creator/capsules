...
bcs.registerStructType(
  "0x390d9fbd00f96974df331c15686ec661a52aae03b9fc15e5a10e6dec65d594c::typed_id::TypedID<T>",
  {
    id: `0x2::object::ID`,
  }
);
...
export function isTypedID(type: Type): boolean {
  return type.startsWith(
    "0x390d9fbd00f96974df331c15686ec661a52aae03b9fc15e5a10e6dec65d594c::typed_id::TypedID<"
  );
}
