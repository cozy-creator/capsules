...
bcs.registerStructType(
    "0xa17ae8f9e52566906c045e034b5e3f1b1ca88dc3aa8ce72e829e35aa46e5e77e::data::Key",
    {
...
export function isKey(type: Type): boolean {
    return type === "0xa17ae8f9e52566906c045e034b5e3f1b1ca88dc3aa8ce72e829e35aa46e5e77e::data::Key"
}
...
bcs.registerStructType(
    "0xa17ae8f9e52566906c045e034b5e3f1b1ca88dc3aa8ce72e829e35aa46e5e77e::data::WRITE",
    {
        dummy_field: `bool`,
    }
)
...
export function isWRITE(type: Type): boolean {
    return (
        type === "0xa17ae8f9e52566906c045e034b5e3f1b1ca88dc3aa8ce72e829e35aa46e5e77e::data::WRITE"
    )
}
