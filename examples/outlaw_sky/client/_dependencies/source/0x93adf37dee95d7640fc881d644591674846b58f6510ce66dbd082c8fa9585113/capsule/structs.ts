...
bcs.registerStructType(
    "0x93adf37dee95d7640fc881d644591674846b58f6510ce66dbd082c8fa9585113::capsule::Key",
    {
        dummy_field: `bool`,
    }
)
...
export function isKey(type: Type): boolean {
    return (
        type === "0x93adf37dee95d7640fc881d644591674846b58f6510ce66dbd082c8fa9585113::capsule::Key"
    )
}
...
bcs.registerStructType(
    "0x93adf37dee95d7640fc881d644591674846b58f6510ce66dbd082c8fa9585113::capsule::Witness",
    {
        dummy_field: `bool`,
    }
)
...
bcs.registerStructType(
    "0x93adf37dee95d7640fc881d644591674846b58f6510ce66dbd082c8fa9585113::capsule::Capsule<T>",
    {
        id: `0x2::object::UID`,
...
export function isCapsule(type: Type): boolean {
    return type.startsWith(
        "0x93adf37dee95d7640fc881d644591674846b58f6510ce66dbd082c8fa9585113::capsule::Capsule<"
    )
}
...
export class Capsule<T> {
    ...
    static fromFields<T>(typeArg: Type, fields: Record<string, any>): Capsule<T> {
        ...
        return new Capsule(typeArg, {
            ...
            contents: Option.fromFields<T>(`${typeArg}`, fields.contents).vec[0] || null,
        })
    }
    ...
    static fromBcs<T>(typeArg: Type, data: Uint8Array | string, encoding?: Encoding): Capsule<T> {
        return Capsule.fromFields(typeArg, bcs.de([Capsule.$typeName, typeArg], data, encoding))
    }
    ...
    static async fetch<T>(provider: JsonRpcProvider, id: ObjectId): Promise<Capsule<T>> {
        const res = await provider.getObject({
            id,
            options: { showContent: true },
        })
        if (res.error) {
            throw new Error(`error fetching Capsule object at id ${id}: ${res.error.code}`)
        }
        if (res.data?.content?.dataType !== "moveObject" || !isCapsule(res.data.content.type)) {
