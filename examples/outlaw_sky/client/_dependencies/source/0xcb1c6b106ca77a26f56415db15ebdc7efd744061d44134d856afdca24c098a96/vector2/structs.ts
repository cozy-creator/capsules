...
bcs.registerStructType(
  "0xcb1c6b106ca77a26f56415db15ebdc7efd744061d44134d856afdca24c098a96::vector2::Out<T>",
  {
    vec: `vector<T>`,
    start: `u64`,
    end: `u64`,
...
export function isOut(type: Type): boolean {
  return type.startsWith(
    "0xcb1c6b106ca77a26f56415db15ebdc7efd744061d44134d856afdca24c098a96::vector2::Out<"
  );
}
