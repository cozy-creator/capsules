...
bcs.registerStructType(
    "0xcb1c6b106ca77a26f56415db15ebdc7efd744061d44134d856afdca24c098a96::map::Iter<Key>",
    {
        for: `0x2::object::ID`,
        keys: `vector<Key>`,
    }
...
export function isIter(type: Type): boolean {
    return type.startsWith(
        "0xcb1c6b106ca77a26f56415db15ebdc7efd744061d44134d856afdca24c098a96::map::Iter<"
    )
}
...
bcs.registerStructType(
    "0xcb1c6b106ca77a26f56415db15ebdc7efd744061d44134d856afdca24c098a96::map::Map<Key, Value>",
    {
        id: `0x2::object::UID`,
        index: `vector<Key>`,
    }
...
export function isMap(type: Type): boolean {
    return type.startsWith(
        "0xcb1c6b106ca77a26f56415db15ebdc7efd744061d44134d856afdca24c098a96::map::Map<"
    )
}
