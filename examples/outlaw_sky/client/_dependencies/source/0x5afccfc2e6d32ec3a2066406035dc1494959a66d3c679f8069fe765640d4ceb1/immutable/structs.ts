...
bcs.registerStructType(
    "0x5afccfc2e6d32ec3a2066406035dc1494959a66d3c679f8069fe765640d4ceb1::immutable::Immutable<T>",
    {
        id: `0x2::object::UID`,
        allow_read: `bool`,
        contents: `T`,
...
export function isImmutable(type: Type): boolean {
    return type.startsWith(
        "0x5afccfc2e6d32ec3a2066406035dc1494959a66d3c679f8069fe765640d4ceb1::immutable::Immutable<"
    )
}
