...
bcs.registerStructType(
    "0x5afccfc2e6d32ec3a2066406035dc1494959a66d3c679f8069fe765640d4ceb1::vec_set2::VecSet<K>",
    {
        contents: `vector<K>`,
    }
)
...
export function isVecSet(type: Type): boolean {
    return type.startsWith(
        "0x5afccfc2e6d32ec3a2066406035dc1494959a66d3c679f8069fe765640d4ceb1::vec_set2::VecSet<"
    )
}
