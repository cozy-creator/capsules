...
bcs.registerStructType(
  "0x6188f77679f6b756f23557e9289fa7eacfaab7fc17e485ac22088e34e5fb5786::vector2::Out<T>",
  {
    vec: `vector<T>`,
    start: `u64`,
    end: `u64`,
...
export function isOut(type: Type): boolean {
  return type.startsWith(
    "0x6188f77679f6b756f23557e9289fa7eacfaab7fc17e485ac22088e34e5fb5786::vector2::Out<"
  );
}
