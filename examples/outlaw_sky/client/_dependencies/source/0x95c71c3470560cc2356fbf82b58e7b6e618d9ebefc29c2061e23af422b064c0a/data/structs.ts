...
bcs.registerStructType(
    "0x95c71c3470560cc2356fbf82b58e7b6e618d9ebefc29c2061e23af422b064c0a::data::Key",
    {
...
export function isKey(type: Type): boolean {
    return type === "0x95c71c3470560cc2356fbf82b58e7b6e618d9ebefc29c2061e23af422b064c0a::data::Key"
}
...
bcs.registerStructType(
    "0x95c71c3470560cc2356fbf82b58e7b6e618d9ebefc29c2061e23af422b064c0a::data::WRITE",
    {
        dummy_field: `bool`,
    }
)
...
export function isWRITE(type: Type): boolean {
    return (
        type === "0x95c71c3470560cc2356fbf82b58e7b6e618d9ebefc29c2061e23af422b064c0a::data::WRITE"
    )
}
