...
bcs.registerStructType(
    "0x31681d6b25defefb41f78fc68e9fd0dfead6e20140f934dcd9f86d01d7d813e1::data::Key",
    {
...
export function isKey(type: Type): boolean {
    return type === "0x31681d6b25defefb41f78fc68e9fd0dfead6e20140f934dcd9f86d01d7d813e1::data::Key"
}
...
bcs.registerStructType(
    "0x31681d6b25defefb41f78fc68e9fd0dfead6e20140f934dcd9f86d01d7d813e1::data::WRITE",
    {
        dummy_field: `bool`,
    }
)
...
export function isWRITE(type: Type): boolean {
    return (
        type === "0x31681d6b25defefb41f78fc68e9fd0dfead6e20140f934dcd9f86d01d7d813e1::data::WRITE"
    )
}
