...
bcs.registerStructType(
    "0xfbf59d4ea15bc2da870cd74991503ae3c504bb108061ba5d7270fd0bb0be00b2::map::Iter<Key>",
    {
        for: `0x2::object::ID`,
        keys: `vector<Key>`,
    }
...
export function isIter(type: Type): boolean {
    return type.startsWith(
        "0xfbf59d4ea15bc2da870cd74991503ae3c504bb108061ba5d7270fd0bb0be00b2::map::Iter<"
    )
}
...
bcs.registerStructType(
    "0xfbf59d4ea15bc2da870cd74991503ae3c504bb108061ba5d7270fd0bb0be00b2::map::Map<Key, Value>",
    {
        id: `0x2::object::UID`,
        index: `vector<Key>`,
    }
...
export function isMap(type: Type): boolean {
    return type.startsWith(
        "0xfbf59d4ea15bc2da870cd74991503ae3c504bb108061ba5d7270fd0bb0be00b2::map::Map<"
    )
}
