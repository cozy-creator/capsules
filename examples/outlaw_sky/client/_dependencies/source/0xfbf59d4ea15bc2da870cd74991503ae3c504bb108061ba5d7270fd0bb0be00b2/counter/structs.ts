...
bcs.registerStructType(
    "0xfbf59d4ea15bc2da870cd74991503ae3c504bb108061ba5d7270fd0bb0be00b2::counter::Counter<T>",
    {
        id: `0x2::object::UID`,
        value: `u256`,
    }
...
export function isCounter(type: Type): boolean {
    return type.startsWith(
        "0xfbf59d4ea15bc2da870cd74991503ae3c504bb108061ba5d7270fd0bb0be00b2::counter::Counter<"
    )
}
...
export class Counter {
    ...
    static fromBcs(typeArg: Type, data: Uint8Array | string, encoding?: Encoding): Counter {
        return Counter.fromFields(typeArg, bcs.de([Counter.$typeName, typeArg], data, encoding))
    }
