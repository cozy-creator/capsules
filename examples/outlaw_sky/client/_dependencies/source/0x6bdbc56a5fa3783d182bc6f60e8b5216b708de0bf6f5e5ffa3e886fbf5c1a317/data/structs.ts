...
export function isKey(type: Type): boolean {
    return type === "0x6bdbc56a5fa3783d182bc6f60e8b5216b708de0bf6f5e5ffa3e886fbf5c1a317::data::Key"
}
...
export function isWRITE(type: Type): boolean {
    return (
        type === "0x6bdbc56a5fa3783d182bc6f60e8b5216b708de0bf6f5e5ffa3e886fbf5c1a317::data::WRITE"
    )
}
