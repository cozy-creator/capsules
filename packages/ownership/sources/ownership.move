...
#[test_only]
module ownership::ownership_test {
    ...
    public fun test_sanity() {
        ...
        let scenario = test_scenario::begin(blue);
        {
            ...
            let auth = tx_authority::begin(test_scenario::ctx(&mut scenario));

            ownership::initialize_owner_and_transfer_authority<Car>(&mut car.id, blue, &auth);
            // ownership::transfer(&mut car.id, red, &auth);
