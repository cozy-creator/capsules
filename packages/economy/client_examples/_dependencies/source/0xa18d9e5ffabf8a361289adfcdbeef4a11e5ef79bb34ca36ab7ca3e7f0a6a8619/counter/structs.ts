...
bcs.registerStructType(
  "0xa18d9e5ffabf8a361289adfcdbeef4a11e5ef79bb34ca36ab7ca3e7f0a6a8619::counter::Counter<T>",
  {
    id: `0x2::object::UID`,
    value: `u256`,
  },
...
export function isCounter(type: Type): boolean {
  return type.startsWith(
    "0xa18d9e5ffabf8a361289adfcdbeef4a11e5ef79bb34ca36ab7ca3e7f0a6a8619::counter::Counter<",
  );
}
