...
bcs.registerStructType(
  "0xdcbadd322069f668204440a6245922a705922e9d1e061543c4bbf388d62d92db::organization::Witness",
  {
    dummy_field: `bool`,
  },
);
...
bcs.registerStructType(
  "0xdcbadd322069f668204440a6245922a705922e9d1e061543c4bbf388d62d92db::organization::Package",
  {
    id: `0x2::object::UID`,
...
export class Package {
  ...
  static async fetch(
    ...
    if (res.error) {
      throw new Error(
        `error fetching Package object at id ${id}: ${res.error.code}`,
      );
    }
    if (
      res.data?.content?.dataType !== "moveObject" ||
      !isPackage(res.data.content.type)
    ) {
...
bcs.registerStructType(
  "0xdcbadd322069f668204440a6245922a705922e9d1e061543c4bbf388d62d92db::organization::Key",
  {
    dummy_field: `bool`,
  },
);
...
bcs.registerStructType(
  "0xdcbadd322069f668204440a6245922a705922e9d1e061543c4bbf388d62d92db::organization::ADD_PACKAGE",
  {
    dummy_field: `bool`,
  },
);
...
export class ADD_PACKAGE {
  ...
  static fromBcs(data: Uint8Array | string, encoding?: Encoding): ADD_PACKAGE {
    return ADD_PACKAGE.fromFields(
      bcs.de([ADD_PACKAGE.$typeName], data, encoding),
    );
  }
}
...
bcs.registerStructType(
  "0xdcbadd322069f668204440a6245922a705922e9d1e061543c4bbf388d62d92db::organization::ENDORSE",
  {
    dummy_field: `bool`,
  },
);
...
bcs.registerStructType(
  "0xdcbadd322069f668204440a6245922a705922e9d1e061543c4bbf388d62d92db::organization::Endorsement",
  {
    from: `address`,
  },
);
...
export class Endorsement {
  ...
  static fromBcs(data: Uint8Array | string, encoding?: Encoding): Endorsement {
    return Endorsement.fromFields(
      bcs.de([Endorsement.$typeName], data, encoding),
    );
  }
}
...
bcs.registerStructType(
  "0xdcbadd322069f668204440a6245922a705922e9d1e061543c4bbf388d62d92db::organization::Organization",
  {
    id: `0x2::object::UID`,
    packages: `vector<0xdcbadd322069f668204440a6245922a705922e9d1e061543c4bbf388d62d92db::organization::Package>`,
    rbac: `0xdcbadd322069f668204440a6245922a705922e9d1e061543c4bbf388d62d92db::rbac::RBAC`,
  },
);
...
export class Organization {
  ...
  static fromFieldsWithTypes(item: FieldsWithTypes): Organization {
    ...
    return new Organization({
      id: item.fields.id.id,
      packages: item.fields.packages.map((item: any) =>
        Package.fromFieldsWithTypes(item),
      ),
  ...
  static fromBcs(data: Uint8Array | string, encoding?: Encoding): Organization {
    return Organization.fromFields(
      bcs.de([Organization.$typeName], data, encoding),
    );
  }
  ...
  static fromSuiParsedData(content: SuiParsedData) {
    ...
    if (!isOrganization(content.type)) {
      throw new Error(
        `object at ${content.fields.id} is not a Organization object`,
      );
    }
  ...
  static async fetch(
    ...
    if (res.error) {
      throw new Error(
        `error fetching Organization object at id ${id}: ${res.error.code}`,
      );
    }
    if (
      res.data?.content?.dataType !== "moveObject" ||
...
bcs.registerStructType(
  "0xdcbadd322069f668204440a6245922a705922e9d1e061543c4bbf388d62d92db::organization::REMOVE_PACKAGE",
  {
    dummy_field: `bool`,
  },
);
...
export class REMOVE_PACKAGE {
  ...
  static fromBcs(
    ...
    return REMOVE_PACKAGE.fromFields(
      bcs.de([REMOVE_PACKAGE.$typeName], data, encoding),
    );
  }
}
