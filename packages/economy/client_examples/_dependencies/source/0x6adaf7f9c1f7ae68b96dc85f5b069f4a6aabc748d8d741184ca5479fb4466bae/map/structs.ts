...
bcs.registerStructType(
  "0x6adaf7f9c1f7ae68b96dc85f5b069f4a6aabc748d8d741184ca5479fb4466bae::map::Iter<Key>",
  {
    for: `0x2::object::ID`,
    keys: `vector<Key>`,
  },
...
export function isIter(type: Type): boolean {
  return type.startsWith(
    "0x6adaf7f9c1f7ae68b96dc85f5b069f4a6aabc748d8d741184ca5479fb4466bae::map::Iter<",
  );
}
...
bcs.registerStructType(
  "0x6adaf7f9c1f7ae68b96dc85f5b069f4a6aabc748d8d741184ca5479fb4466bae::map::Map<Key, Value>",
  {
    id: `0x2::object::UID`,
    index: `vector<Key>`,
  },
...
export function isMap(type: Type): boolean {
  return type.startsWith(
    "0x6adaf7f9c1f7ae68b96dc85f5b069f4a6aabc748d8d741184ca5479fb4466bae::map::Map<",
  );
}
