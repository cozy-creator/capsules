...
export class Wrapper<Name> {
  ...
  static fromFields<Name>(
    ...
    return new Wrapper(
      typeArg,
      structClassLoaderSource.fromFields(typeArg, fields.name),
    );
  }
  ...
  static fromFieldsWithTypes<Name>(item: FieldsWithTypes): Wrapper<Name> {
    ...
    return new Wrapper(
      typeArgs[0],
      structClassLoaderSource.fromFieldsWithTypes(
        typeArgs[0],
        item.fields.name,
      ),
    );
  ...
  static fromBcs<Name>(
    ...
    return Wrapper.fromFields(
      typeArg,
      bcs.de([Wrapper.$typeName, typeArg], data, encoding),
    );
  }
}
