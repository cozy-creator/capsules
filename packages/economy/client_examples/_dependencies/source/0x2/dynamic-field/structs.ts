...
export class Field<Name, Value> {
  ...
  static fromFieldsWithTypes<Name, Value>(
    ...
    return new Field([typeArgs[0], typeArgs[1]], {
      ...
      name: structClassLoaderSource.fromFieldsWithTypes(
        typeArgs[0],
        item.fields.name,
      ),
  ...
  static fromBcs<Name, Value>(
    ...
    return Field.fromFields(
      typeArgs,
      bcs.de([Field.$typeName, ...typeArgs], data, encoding),
    );
  }
