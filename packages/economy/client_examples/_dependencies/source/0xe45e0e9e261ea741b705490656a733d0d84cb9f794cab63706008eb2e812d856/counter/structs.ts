...
bcs.registerStructType(
  "0xe45e0e9e261ea741b705490656a733d0d84cb9f794cab63706008eb2e812d856::counter::Counter<T>",
  {
    id: `0x2::object::UID`,
    value: `u256`,
  },
...
export function isCounter(type: Type): boolean {
  return type.startsWith(
    "0xe45e0e9e261ea741b705490656a733d0d84cb9f794cab63706008eb2e812d856::counter::Counter<",
  );
}
