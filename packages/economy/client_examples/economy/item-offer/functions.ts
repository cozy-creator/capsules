...
export function returnAndShare(
  ...
  return txb.moveCall({
    target: `${PUBLISHED_AT}::item_offer::return_and_share`,
...
export function cancel(txb: TransactionBlock) {
  return txb.moveCall({
    target: `${PUBLISHED_AT}::item_offer::cancel`,
    arguments: [],
  });
}
...
export function cancel_(txb: TransactionBlock) {
  return txb.moveCall({
    target: `${PUBLISHED_AT}::item_offer::cancel_`,
    arguments: [],
  });
}
...
export function createOffer_(txb: TransactionBlock) {
  return txb.moveCall({
    target: `${PUBLISHED_AT}::item_offer::create_offer_`,
    arguments: [],
  });
}
...
export function isTypeOffer(
  ...
  return txb.moveCall({
    target: `${PUBLISHED_AT}::item_offer::is_type_offer`,
    typeArguments: [typeArg],
...
export function isValid(
  ...
  return txb.moveCall({
    target: `${PUBLISHED_AT}::item_offer::is_valid`,
    typeArguments: [typeArg],
...
export function makeOffer(
  ...
  return txb.moveCall({
    target: `${PUBLISHED_AT}::item_offer::make_offer`,
    typeArguments: [typeArg],
    arguments: [
...
export function objectOfferInfo(
  ...
  return txb.moveCall({
    target: `${PUBLISHED_AT}::item_offer::object_offer_info`,
    typeArguments: [typeArg],
    arguments: [obj(txb, offer)],
  });
}
...
export function takeOffer(
  ...
  return txb.moveCall({
    target: `${PUBLISHED_AT}::item_offer::take_offer`,
    typeArguments: [typeArg],
    arguments: [
      obj(txb, args.offer),
...
export function takeOffer_(
  ...
  return txb.moveCall({
    target: `${PUBLISHED_AT}::item_offer::take_offer_`,
    typeArguments: [typeArg],
    arguments: [
      obj(txb, args.offer),
      obj(txb, args.offerAccount),
...
export function typeOfferInfo(
  ...
  return txb.moveCall({
    target: `${PUBLISHED_AT}::item_offer::type_offer_info`,
    typeArguments: [typeArg],
    arguments: [obj(txb, offer)],
  });
}
